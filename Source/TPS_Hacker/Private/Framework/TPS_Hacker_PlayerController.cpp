...
void ATPS_Hacker_PlayerController::BeginPlay()
{
	Super::BeginPlay();
...
void ATPS_Hacker_PlayerController::SetupInputComponent()
{
...
bool ATPS_Hacker_PlayerController::GetAimHitPoint(FVector& OutHitPoint, float Range, ECollisionChannel TraceChannel,
