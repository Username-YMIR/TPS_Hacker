...
void UObjectPoolComponent::GetPoolStats(TSubclassOf<AActor> ActorClass, int32& OutTotal, int32& OutActive,
                                        int32& OutInactive) const
{
...
void UObjectPoolComponent::SetPooledActive(AActor* Actor, const FTransform& XForm)
{
	...
	// OnAcquireFromPool에서 각자 하는 것으로 변경
